...
@{
    ...
    Copyright         = "(c) 2020 Kevin A. Lee. All rights reserved."
    ...
    FunctionsToExport = @("Add-FODApplication", "Get-FODApplication", "Get-FODApplications", "Get-FODConfig", "Get-FODToken", "New-FODApplicationObject",
        "New-FODAttributeObject", "New-FODMicroserviceObject", "New-FODReleaseObject", "New-FODUserGroupObject", "New-FODUserObject", "Remove-FODApplication",
