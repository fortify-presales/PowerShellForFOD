...
FunctionsToExport = @('Add-FODApplication', 'Add-FODRelease', 'Add-FODUser', 
               ...
               'Get-FODDynamicScanSetup', 'Get-FODOpenSourceComponents', 'Get-FODRelease',
               'Get-FODMicroservices', 'Add-FODMicroservice', 'Update-FODMicroservice', 'Remove-FODMicroservice',
               'Get-FODReleaseAssessmentTypes', 'Get-FODReleaseId', 
               'Get-FODReleases', 'Get-FODReleaseScan', 'Get-FODReleaseScans', 
               'Get-FODScans', 'Get-FODScanSummary', 'Get-FODTenantHeatMaps', 'Get-FODToken', 'Get-FODUser',
               'Get-FODUserApplicationAccess', 'Get-FODUserGroupApplicationAccess', 
               'Get-FODUserGroups', 'Get-FODUserId', 'Get-FODUsers', 
               'Get-FODVulnerabilities', 'Import-FODApplicationAuditTemplates', 
               'Import-FODDynamicScan', 'Import-FODStaticScan', 
               'New-FODApplicationObject', 'New-FODAttributeObject', 
               'New-FODMicroserviceObject', 'New-FODReleaseObject', 
               'New-FODUserGroupObject', 'New-FODUserObject', 
