...
FunctionsToExport = @('Add-FODApplication', 'Add-FODRelease', 'Add-FODUser', 
               ...
               'Export-FODApplicationAuditTemplates',
               'Get-FODApplication', 'Get-FODApplications',
               'Get-FODApplicationScans', 'Get-FODAttributes', 'Get-FODConfig', 
               'Get-FODRelease', 'Get-FODReleases', 'Get-FODReleaseId', 'Get-FODReleaseScan',
               'Get-FODReleaseScans', 'Get-FODScans', 'Get-FODScanSummary', 
               'Get-FODToken', 'Get-FODUser', 'Get-FODUserApplicationAccess', 
               'Get-FODUserGroupApplicationAccess', 'Get-FODUserGroups', 
               'Get-FODUsers', 'Get-FODVulnerabilities', 'Import-FODDynamicScan', 
               'Import-FODStaticScan', 'Import-FODApplicationAuditTemplates',
