...
FunctionsToExport = @('Add-FODApplication', 'Add-FODMicroservice', 'Add-FODRelease', 
               'Add-FODUser', 'Add-FODUserApplicationAccess', 
               'Add-FODUserGroupApplicationAccess', 
               ...
               'Get-FODDynamicScanSetup', 'Get-FODMicroservices', 
               'Get-FODOpenSourceComponents', 'Get-FODRelease', 
               'Get-FODReleaseAssessmentTypes', 'Get-FODReleaseId', 
               'Get-FODReleases', 'Get-FODReleaseScan', 'Get-FODReleaseScans', 
               'Get-FODScans', 'Get-FODScanSummary', 'Get-FODTenantHeatMaps', 
               'Get-FODToken', 'Get-FODUser', 'Get-FODUserApplicationAccess', 
               'Get-FODUserGroupApplicationAccess', 'Get-FODUserGroups', 
               'Get-FODUserId', 'Get-FODUsers', 'Get-FODVulnerabilities', 
               'Import-FODApplicationAuditTemplates', 'Import-FODDynamicScan', 
               'Import-FODStaticScan', 'New-FODApplicationObject', 
               'New-FODAttributeObject', 'New-FODMicroserviceObject', 
               'New-FODReleaseObject', 'New-FODUserGroupObject', 'New-FODUserObject', 
               'Remove-FODApplication', 'Remove-FODMicroservice', 
               ...
               'Test-FODApplication', 'Test-FODRelease', 'Update-FODApplication', 
               'Update-FODDynamicScanSetup', 'Update-FODMicroservice', 
